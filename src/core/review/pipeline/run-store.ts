 ...
 *
 * This module owns run.json and the run's lifecycle: creating a run, writing a
 * review into it, and deciding whether it is finished, stale, or abandoned.
 * The artifact and the paths themselves are artifact.ts; run.ts drives the
